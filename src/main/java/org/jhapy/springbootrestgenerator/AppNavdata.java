...
public class AppNavdata {
	...
	private final static String remoteServiceName = "app-referencedata-server";
	private final static String clientPackage 		= "com.eflightmgt.frontend.client.navdata";

	private final static String mapperPackage 		= "com.eflightmgt.referencedata.converter.navdata";
	private final static String endpointPackage 	= "com.eflightmgt.referencedata.endpoint.navdata";
	private final static String servicePackage 		= "com.eflightmgt.referencedata.service.navdata";
	private final static String repositoryPackage = "com.eflightmgt.referencedata.repository.relationaldb.navdata";
	private final static String domainPackage 		= "com.eflightmgt.referencedata.domain.relationaldb.navdata";

	private final static String dtoPackage 				= "com.eflightmgt.dto.domain.navdata";

	private final static String restServicePrefix = "/api/navdata";
	...
	public static void main(String[] args) {
		...
		parseEntityNamesFromFolder("domain/relationaldb/navdata");
		parseEntities("/navdata");
	}
